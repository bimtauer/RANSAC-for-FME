This is my ongoing project of building a Python RANSAC (almost) from scratch since I grew impatient with all the workarounds I had to come up with to make python-pcl work for me. 
